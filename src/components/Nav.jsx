...
export default function Nav(props) {
  return (
    <div className='p-2 w-28 flex flex-col bg-zinc-900 justify-evenly'>
        {/* <Link to="/gameview">Play</Link>
        <Link to="/deckbuilder">Decks</Link>
        <Link to="/lobby">Friends</Link> */}
        <Link to="/gameview"><NavBarIcon icon={<FaGamepad size="40" />} text='Game'/></Link>
        <Link to="/lobby"><NavBarIcon icon={<BsFillChatDotsFill size="40" />} text='Chat' /></Link>
        <Link to="/deckbuilder"><NavBarIcon icon={<GiCardAceSpades size="40" />} text='Deck Builder'/></Link>
        <Link to="/profile"><NavBarIcon icon={<CgProfile size="40" />} text='Profile'/></Link>
        <Link to="/friends"><NavBarIcon icon={<FaUserFriends size="40" />} text='Friends'/></Link>
