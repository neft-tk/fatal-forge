      ...
      <Modal show={showModal} size="md" popup={true} onClose={onModalClose}>
        <Modal.Header className="bg-slate-600">
          <Modal.Body className="bg-slate-500">
            <div className="flex flex-col space-y-6 px-6 pb-4 sm:pb-6 lg:px-10 xl:pb-10 justify-center items-center text-center">
              <h1 className="mt-4 text-md font-bold text-gray-900 dark:text-white">How To Play:</h1>
