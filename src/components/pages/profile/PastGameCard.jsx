...
function PastGameCard({ deck }) {
  return (
    <>
      ...
      <div className="flex flex-col m-2 items-center border-2 border-red-500 justify-around rounded bg-main-bg">
        ...
        <div>
          <h3 className='text-center text-2xl font-bold text-main-text'>VS.</h3>
        </div>
