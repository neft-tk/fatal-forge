...
function PastGameCard({deck}) {
  return (
    <>
      ...
      <div className="flex m-4 p-4 items-center border-2 border-red-900 justify-around rounded bg-gradient-to-r from-red-600 via-yellow-400 to-red-600">
        <div className="flex flex-col items-center">
          <h3 className="text-red-900 text-2xl font-bold mb-4">Defeat...</h3>
        ...
        <div>
          <h3 className='text-center text-2xl font-bold text-black'>VS.</h3>
        </div>
      ...
      <div className="flex m-4 p-4 items-center border-2 border-green-900 justify-around rounded bg-gradient-to-r from-green-700 via-yellow-200 to-green-700">
      <div className="flex flex-col items-center">
        ...
        <img
          ...
          alt="Deck's Back of Card"
        />
        <h3 className="text-main-text text-lg">{deck[1].deckName}</h3>
      </div>
      <div>
        <h3 className='text-center text-2xl font-bold text-black'>VS.</h3>
      </div>
